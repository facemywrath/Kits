package facemywrath.kitstest.util;
...
public class ItemCreator {
	...
	public TextComponent getTextComponent(String text) {
		...
		net.minecraft.server.v1_8_R3.ItemStack nms = CraftItemStack.asNMSCopy(this.build());
	...
	public ItemCreator setLoreLine(int line, String text) {
